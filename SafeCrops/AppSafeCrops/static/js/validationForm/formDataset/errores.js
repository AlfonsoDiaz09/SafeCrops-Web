...
const errores = {
    error_nombreDataset: 'Debe contener de 4 a 45 caracteres y sólo puede contener: <br> * Letras minúsculas (a-z). <br> * Letras mayúsculas (A-Z). <br> * Dígitos numéricos (0-9). <br> * Carácteres acentuados. <br> * Espacios en blanco.',
    error_tipoDataset: 'Debe seleccionar una opción válida',
    error_segmentacion_SAM: 'Debe seleccionar una opción válida',
    error_homogenizacion_YIQ: 'Debe seleccionar una opción válida',
