...
const validarFormularioAdministrador = (e) => {
    switch (e.target.name){
        case "id_Administrador":
            validarCampoText(expresiones.id_Administrador, e.target, e.target.name, errores.error_id_Administrador, e.target.parentElement);
        break;
...
export default validarFormularioAdministrador;