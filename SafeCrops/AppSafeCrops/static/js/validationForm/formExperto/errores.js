...
const errores = {
    ...
    error_institucionPerteneciente: 'Debe contener de 5 a 100 caracteres y sólo puede contener: <br> * Letras minúsculas (a-z). <br> * Letras mayúsculas (A-Z). <br> * Carácteres acentuados. <br> * Espacios en blanco.',
