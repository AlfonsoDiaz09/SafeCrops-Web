...
def download_weights():
    if not os.path.exists('yolov7.pt'):
        ...
        print("El archivo de pesos yolov7.pt ya está descargado")

    if not os.path.exists('yolov7-tiny.pt'):
        wget.download('https://github.com/WongKinYiu/yolov7/releases/download/v0.1/yolov7-tiny.pt')
    else:
        print("El archivo de pesos yolov7-tiny.pt ya está descargado")
